  ...
  function k(t) {
    return t !== IDBDatabase.prototype.transaction ||
      ...
      ? (
        ...
        ? function (...e) {
            return t.apply(M(this), e), T(I.get(this))
          }
        : function (...e) {
            return T(t.apply(M(this), e))
          }
      : function (e, ...s) {
  ...
  ;(t.CacheFirst = class extends v {
    ...
    (t.ExpirationPlugin = class {
      ...
      Z(t) {
        ...
        let e = this.et.get(t)
        return e || ((e = new H(t, this.tt)), this.et.set(t, e)), e
      }
      Y(t) {
        if (!this.T) return !0
        const e = this.st(t)
...
//# sourceMappingURL=workbox-87b8d583.js.map
